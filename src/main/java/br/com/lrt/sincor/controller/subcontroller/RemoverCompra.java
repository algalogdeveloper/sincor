...
public class RemoverCompra implements Invoke {

	@Override
	public Object invoke(HttpServletRequest request, HttpServletResponse response, Permissao permissao) {
		CompraService compraService =  new CompraService(new CompraRepository());
		return compraService.removendoCompraDoCliente(Long.parseLong(request.getParameter("param")));
	}
